...
model = load_model('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/Model3.h5')
...
def get_image_size():
	img = cv2.imread('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures2/0/100.jpg', 0)
	return img.shape
