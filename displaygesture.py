...
def get_image_size():
	img = cv2.imread('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures/1/100.jpg', 0)
	return img.shape

gestures = os.listdir('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures/')
print(gestures)
...
for i in range(rows):
	...
	for j in range(begin_index, end_index):
		img_path = "D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures/%s/%d.jpg" % (j, random.randint(1, 1200))
