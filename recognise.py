...
from tf_trainingmodel import cnn_model_fn
...
estim = tf.estimator.Estimator

os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'
#classifier = estim(model_dir="tmp/cnn_model2", model_fn=cnn_model_fn)
prediction = None
model = load_model('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/cnn_model_keras2.h5')

def get_image_size():
	img = cv2.imread('D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures/0/100.jpg', 0)
	return img.shape
...
def get_pred_text_from_db(pred_class):
	conn = sqlite3.connect("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gesture_db.db")
