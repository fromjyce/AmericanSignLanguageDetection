...
def pickle_images_labels():
	images_labels = []
	images = glob("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/gestures2/*/*.jpg")
	images.sort()
	for image in images:
		print(image)
...
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/train_images2", "wb") as f:
	pickle.dump(train_images, f)
del train_images

train_labels = labels[:int(5/6*len(labels))]
print("Length of train_labels", len(train_labels))
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/train_labels2", "wb") as f:
	pickle.dump(train_labels, f)
del train_labels

test_images = images[int(5/6*len(images)):int(11/12*len(images))]
print("Length of test_images", len(test_images))
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/test_images2", "wb") as f:
	pickle.dump(test_images, f)
del test_images

test_labels = labels[int(5/6*len(labels)):int(11/12*len(images))]
print("Length of test_labels", len(test_labels))
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/test_labels2", "wb") as f:
	pickle.dump(test_labels, f)
del test_labels

val_images = images[int(11/12*len(images)):]
print("Length of test_images", len(val_images))
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/val_images2", "wb") as f:
	pickle.dump(val_images, f)
del val_images

val_labels = labels[int(11/12*len(labels)):]
print("Length of val_labels", len(val_labels))
with open("D:/SNU/Github/Programming-in-Python/PIP_Mine_2/val_labels2", "wb") as f:
